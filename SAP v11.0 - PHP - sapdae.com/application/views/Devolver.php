                            ...
                            <div id="muda" class="chit-chat-heading">
                            	...
                            	<div id="divCenter">
                                 <form id="formulario" class="form-signin" style="background-color:white" >
							        ...
							        <label id="muda" for="inputRecurso" class="label" style="color:#2A2E2A">Informação do Projetor:</label>
							        <input id="zoom" type="text" id="inputRecurso" class="form-control" placeholder="Tombo do Projetor" required>
							         
							       

							        <button   id="muda" class="btn btn-success " type="button" >Confirmar Devolução</button>
							        <a href="../Projeto/alugar"><button   id="muda" class="btn btn-success " type="button" >Voltar para Alugar</button></a>
