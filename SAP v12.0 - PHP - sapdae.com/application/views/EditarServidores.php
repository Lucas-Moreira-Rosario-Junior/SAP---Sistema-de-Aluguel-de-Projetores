								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li id="muda"> <a href="/sap/"><i class="fa fa-sign-out"></i> Sair</a> </li>
										</ul>
									</li>
								</ul>
							</div>
	...
	<div style="margin-bottom: 25px;" class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div id="muda" class="chit-chat-heading">
                                  Atualizar dados de Servidores/Técnicos Adm.
                            </div>
                           		
                            
                            	<div id="divCenter">
                            		
                                 <form action="../editarServ" id="formulario" class="form-signin" style="background-color:white" method="post">
        
							        <label id="muda" class="label" style="color:#2A2E2A">Matrícula do Servidor:</label>
							        <input id="zoom" name="MatriculaServidor" value="<?php echo $servidor->MatriculaServidor ?>" type="text" class="form-control" placeholder="Matrícula Servidor(a)" required="" >
							        <label id="muda" class="label" style="color:#2A2E2A">Nome Completo:</label>
							        <input id="zoom" name="nomeServidor" value="<?php echo $servidor->nomeServidor ?>" type="text" class="form-control" placeholder="Nome" required >
							        <label id="muda" class="label" style="color:#2A2E2A">Setor:</label>
							        <input id="zoom" name="setorServidor" value="<?php echo $servidor->setorServidor ?>" type="text" class="form-control" placeholder="Setor" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Email:</label>
							        <input id="zoom" name="emailServidor" value="<?php echo $servidor->emailServidor ?>" type="text" class="form-control" placeholder="Email" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Telefone:</label>
							        <input id="zoom" name="telefoneServidor" value="<?php echo $servidor->telefoneServidor ?>" type="text" class="form-control" placeholder="Telefone" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Senha:</label>
							        <input id="zoom" name="senhaServidor" value="<?php echo $servidor->senhaServidor ?>" type="text" class="form-control" placeholder="Senha" required>
							         
							       
							        <input type="hidden" name="MatriculaServidorAnt" value="<?php echo $servidor->MatriculaServidor ?>">
							        <button  id="muda" class="btn btn-success " type="submit" >Confirmar Edição</button>
							        <a  href="../../projeto/servidor"><button  id="muda" class="btn btn-success " type="button" >Voltar</button></a>
