...
<div class="page-container">
      ...
      <div class="row">
        ...
        <a id="zoom" href="../Projeto/CadastroProfessor" class="btn btn-success margin-button15" style="margin-top: 15px;margin-bottom:10px;width: 200px;">Inserir Professor</a>
        ...
        <table class="table table-bordered">
            ...
            <?php
				$contador = 0;
				foreach ($SAP as $professor){        
				echo '<tbody> <tr>'; 
				echo '<td>'.$professor->MatriculaProfessor.'</td>'; 
				echo '<td>'.$professor->nomeProfessor.'</td>';
				echo '<td>'.$professor->departamento.'</td>'; 
				echo '<td>'.$professor->emailProfessor.'</td>'; 
				echo '<td>'.$professor->telefoneProfessor.'</td>';
				echo '<td>'.$professor->senhaProfessor.'</td>';  
				echo '<td class="text-center">';
                        echo '<a href="/SAP/index.php/Projeto/editarProfessor/'.$professor->MatriculaProfessor.'" title="Editar cadastro" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>';
                        echo ' <a href="/SAP/index.php/Projeto/deletarProfessor/'.$professor->MatriculaProfessor.'" title="Apagar cadastro" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
        ...
        <?php echo '<b>Temos: '.$contador.' Professor(es)</b>'; ?>
