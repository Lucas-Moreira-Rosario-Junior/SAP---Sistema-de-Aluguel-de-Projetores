...
<link href="../../bootstrap/css/bootUsuario.css" rel="stylesheet" type="text/css" media="all">
...
<div class="market-updates">
			<div id="zoom" class="col-md-6 market-update-gd">
				<a href="../Projeto/Servidor"><div class="market-update-block clr-block-1">
					<div  class="col-md-8 market-update-left">
						<h3 id="muda">Servidores</h3>
					</div>
			...
			<div id="zoom" class="col-md-6 market-update-gd">
				<a href="../Projeto/Professor"><div class="market-update-block clr-block-2">
				 <div class="col-md-8 market-update-left">
					<h3 id="muda">Professores</h3>
				  </div>
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a id="zoom3" href="#"><i class="fa fa-graduation-cap"></i><span>Listar Servidores</span></a>
		        </li>
