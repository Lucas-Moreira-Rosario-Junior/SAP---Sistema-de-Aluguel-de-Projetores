...
<div class="signup-page-main">
	<div id="zoom" class="cabeca" style="background-color:#F6FBFF;width: 40%;margin: 0 auto;background-size: cover;min-height: 100px;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);"><h1 style="font-family: monospace; font-size:56px;color:black;text-align: center;padding: center">Cadastre-se</h1></div>
     <div class="signup-main">  	
    	 <div class="signup-head">
			...
			<div class="signup-block">
				<form>
					<label>Qual é seu cargo?</label>
					<select style="margin-bottom: 20px" class="form-control" name="carlist" form="carform">
					  <option value="Gerente">Gerente</option>
					  <option value="Professor">Professor</option>
					  <option value="Servidor">Servidor</option>
					  <option value="Funcionario">Funcionario do DAE</option>
					</select>
					<input type="text" name="nome" placeholder="Nome" required="">
					<input type="text" name="telefone" placeholder="Telefone" required="">
					<input type="text" name="setor" placeholder="Setor(Caso tenha)" required="">
					<input type="text" name="departamento" placeholder="Departamento(Caso tenha)" required="">
						...
						<div class="forgot-grid">
							<ul>
								<li>
									...
									<label for="brand1"><span></span>Eu concordo com os termos</label>
								</li>
							</ul>
						</div>
