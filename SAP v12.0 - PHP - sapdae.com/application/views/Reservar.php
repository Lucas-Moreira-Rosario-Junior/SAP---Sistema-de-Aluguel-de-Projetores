	...
	<div style="margin-bottom: 25px;" class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div class="chit-chat-heading">
                            	...
                            	<div id="divCenter">
                                 <form action="salvarReserva"id="formulario" class="form-signin" style="background-color:white" method="post" >
        
							        <label for="inputMatriculaS" class="label" style="color:#2A2E2A">Matrícula do Servidor(a):</label>
							        <select name="inputMatriculaS" id="zoom" type="text" class="form-control" placeholder="Matrícula Servidor(a)" required autofocus>
							        	<?php
							        ...
							        <label for="inputEmprestador" class="label" style="color:#2A2E2A">Emprestado por:</label>
							        <input name="inputEmprestador" id="zoom" type="text" class="form-control" placeholder="Nome" required >
							        
							        <label for="inputRetirado" class="label" style="color:#2A2E2A">Horário de Retirada:</label>
							        <input name="inputRetirado" id="zoom" type="time" class="form-control" placeholder="Horário de Retirada" required>

							        <label for="inputDevolvido" class="label" style="color:#2A2E2A">Horário de Devolução:</label>
							        <input name="inputDevolvido" id="zoom" type="time" class="form-control" placeholder="Horário de Devolução" required>

							        <label for="inputRecurso" class="label" style="color:#2A2E2A;margin-bottom: 30px;">Projetor:</label>
							        <select name="inputRecurso" id="zoom" type="text" class="form-control" placeholder="Número do projetor" required>
							        	<?php
							        ...
							        <input name="inputData" id="zoom" type="date" class="form-control" placeholder="Data" required>
							         
							       

							        <button  id="zoom" class="btn btn-success " type="submit" >Reservar</button>
							        <a href="../Projeto/ReceberReservado"><button  id="zoom" class="btn btn-success " type="button" >Receber reservado</button></a>
