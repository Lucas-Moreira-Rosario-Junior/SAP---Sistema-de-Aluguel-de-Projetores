	...
	<div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div class="chit-chat-heading">
                            	...
                            	<div id="divCenter">
                                 <form action="salvarReservaRecebida" id="formulario" class="form-signin" style="background-color:white" method="post">
							        ...
							        <input name="inputEmprestador" id="zoom" type="text" id="inputRecebido" class="form-control" placeholder="Nome" required>
							        
							        <label for="inputDevolvido" class="label" style="color:#2A2E2A">Horário de Devolução:</label>
							        <input name="inputDevolvido" id="zoom" type="time" id="inputDevolvido" class="form-control" placeholder="Horário de Devolução" required>

							        <label for="inputRecurso" class="label" style="color:#2A2E2A">Projetor:</label>
							        <select name="inputRecurso" id="zoom" type="text" id="inputRecurso" class="form-control" placeholder="Informações do Projetor" required>
							        	<?php
							        ...
							        <button  id="zoom" class="btn btn-success " type="submit">Confirmar Entrega</button>
							        <a href="../Projeto/Reservar"><button id="zoom" class="btn btn-success " type="button" >Voltar</button></a>
							        <a href="../Projeto/home"><button id="zoom" class="btn btn-success " type="button" >Página Principal</button></a>
