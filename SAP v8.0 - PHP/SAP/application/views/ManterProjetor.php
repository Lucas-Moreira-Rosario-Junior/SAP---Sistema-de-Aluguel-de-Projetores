...
<div class="page-container">
      ...
      <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <?php
				$contador = 0;
				foreach ($SAP as $projetor){        
				echo '<tbody> <tr>'; 
				echo '<td>'.$projetor->idProjetor.'</td>'; 
				echo '<td>'.$projetor->Tombo.'</td>';
				echo '<td>'.$projetor->Descricao.'</td>'; 
				echo '<td class="text-center">';
                        echo '<a href="/SAP/index.php/Projeto/editarProjetor/'.$projetor->idProjetor.'" title="Editar cadastro" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>';
                        echo ' <a href="/SAP/index.php/Projeto/deletarProjetor/'.$projetor->idProjetor.'" title="Apagar cadastro" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
                        echo ' <a href="#'.$projetor->idProjetor.'" title="Detalhes" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>';
                      echo '</td>';        
				echo '</tr></tbody>';
				$contador++;
