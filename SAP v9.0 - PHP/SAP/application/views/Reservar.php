                            ...
                            <div class="chit-chat-heading">
                            	...
                            	<div id="divCenter">
                                 <form id="formulario" class="form-signin" style="background-color:white" >
							        ...
							        <input id="zoom" type="text" class="form-control" placeholder="Nome" required >
							        
							        <label for="inputRetirado" class="label" style="color:#2A2E2A">Horário de Retirada:</label>
							        <input id="zoom" type="text" class="form-control" placeholder="Horário de Retirada" required>
							        <label for="inputDevolvido" class="label" style="color:#2A2E2A">Horário de Devolução:</label>
							        <input id="zoom" type="text" class="form-control" placeholder="Horário de Devolução" required>
							        <label for="inputRecurso" class="label" style="color:#2A2E2A;margin-bottom: 30px;">Projetores:</label>
							        <input id="zoom" type="text" class="form-control" placeholder="Número do projetor" required>
							        <label for="inputRetirado" class="label" style="color:#2A2E2A">Data de Reserva:</label>
							        <input id="zoom" type="date" class="form-control" placeholder="Data" required>
							         
							       

							        <button  id="zoom" class="btn btn-success " type="button" >Reservar</button>
