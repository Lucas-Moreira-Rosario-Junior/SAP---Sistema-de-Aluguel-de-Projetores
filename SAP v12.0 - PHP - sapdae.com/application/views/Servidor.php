...
<div class="page-container">
      ...
      <div class="row">
        ...
        <a id="zoom" href="../Projeto/CadastroServidor" class="btn btn-success margin-button15" style="margin-top: 15px;margin-bottom:10px;width: 200px;">Inserir Servidor</a>
        ...
        <table class="table table-bordered">
            ...
            <?php
				$contador = 0;
				foreach ($sapdae as $servidor){        
				echo '<tbody> <tr>'; 
				echo '<td>'.$servidor->MatriculaServidor.'</td>'; 
				echo '<td>'.$servidor->nomeServidor.'</td>';
				echo '<td>'.$servidor->setorServidor.'</td>'; 
				echo '<td>'.$servidor->emailServidor.'</td>';
				echo '<td>'.$servidor->telefoneServidor.'</td>';
		
				echo '<td class="text-center">';
                        echo '<a href="/index.php/Projeto/editarServidor/'.$servidor->MatriculaServidor.'" title="Editar cadastro" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>';
                        echo ' <a href="/index.php/Projeto/deletarServidor/'.$servidor->MatriculaServidor.'" 

                        onclick="return confirm(\'Você tem certeza que deseja deletar? Todo o histórico deste servidor será apagado!\')" 

                        title="Apagar cadastro" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
		...
		<?php echo '<b>Temos: '.$contador.' Servidor(es)</b>'; ?>
