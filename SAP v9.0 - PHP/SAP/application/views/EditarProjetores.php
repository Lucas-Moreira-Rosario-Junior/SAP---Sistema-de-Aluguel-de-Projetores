    	 ...
    	 <div class="signup-head">
			...
			<div class="signup-block">
				...
				<form action="../editarProj" name="form_add" method="post">
				    ...
				    <input name="Descricao"  value="<?php echo $projetor->Descricao ?>" style="height: 200px; width: 100%">
					...
					<input type="hidden" name="idProjetor" value="<?php echo $projetor->idProjetor ?>">
					<td><input id="zoom3" class="botao" type="submit" name="Sign In" value="Editar"></td>
