...
<div class="login-page" >
	<div id="zoom" class="login-main" style="background-color:#F6FBFF;background-size: cover;min-height: 100px;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);font-family: monospace; font-size:56px;color:black;text-align: center;padding-top: 10px;">Login</div>
    <div class="login-main" > 	
    	 <div class="login-head" style="min-height: 251px;">
				
			</div>
			<div class="login-block">
				<form action="/index.php/Projeto/logar" method="POST">
					<input id="zoom" type="text" name="email" placeholder="Email" required="">
					<input id="zoom" type="password" name="password" class="lock" placeholder="Senha">
					<div class="forgot-top-grids">
						<div class="forgot-grid">
							<ul>
								<li>
									<!--<input type="checkbox" id="brand1" value="">
									<label for="brand1"><span></span>Lembre-se de mim</label>-->
								</li>
							</ul>
						</div>
						<div class="forgot">
							<!--<a id="zoom" href="#">Esqueceu a senha?</a>-->
						</div>
						<div class="clearfix"> </div>
					</div>
					<input id="zoom" type="submit" name="Logar" value="Logar">	
					<h3 id="zoom" >Não tem cadastro?<a id="zoom" href="index.php/Projeto/CadastroUsuarios"> Cadastre-se Agora!</a></h3>				
