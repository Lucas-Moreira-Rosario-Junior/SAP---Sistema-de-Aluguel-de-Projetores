...
<div class="inner-block" style="background-color:#FFFFFF">


     <div class="signup-main">
     <div class="cabeca" style="background-color:#F6FBFF;width: 100%;margin: 0 auto;background-size: cover;min-height: 100px;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);"><h1 style="font-family: inherit; font-size:46px;color:black;text-align: center;padding: center">Cadastrar Projetores</h1></div>  	
    	 <div class="signup-head">
			...
			<div class="signup-block">
				<script type="text/javascript">
							      		function validar(){
							      			<?php
							      				foreach ($valido as $projetor) {
							      					echo '
							      						if(document.form_add.idProjetor.value=="'.$projetor->idProjetor.'"){
							      							alert("Já existe o projetor: -->'.$projetor->idProjetor.'<-- no sistema!");
							      							return false;
							      						}';
							      				}
							      			?>
				...
				<form action="salvarProjetores" name="form_add" method="post" onSubmit="return validar();">

					<input id="zoom" type="text" name="idProjetor" placeholder="Número" required="">

					<input id="zoom" type="text" name="Tombo" placeholder="Tombo" required="">

					<label id="zoom" for="Descricao" style="font-family: inherit">Descrição:</label>

					<div id="zoom">

				    <textarea name="Descricao" style="height: 200px; width: 100%"></textarea>
					...
					<td><input id="zoom3" class="botao" type="submit" name="Sign In" value="Cadastrar"></td>
					<td><a href="http://www.sapdae.com/index.php/Projeto/ManterProjetor"><input id="zoom3" class="botao" type="button" name="Sign In" value="Voltar"></a></td>
					</table>
