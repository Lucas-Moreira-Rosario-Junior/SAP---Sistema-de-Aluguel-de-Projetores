      ...
      <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <?php
				...
				echo '<td>'.$servidor->senhaServidor.'</td>';
				echo '<td class="text-center">';
                        echo '<a href="/SAP/index.php/Projeto/editarServidor/'.$servidor->MatriculaServidor.'" title="Editar cadastro" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>';
                        echo ' <a href="/SAP/index.php/Projeto/deletarServidor/'.$servidor->MatriculaServidor.'" title="Apagar cadastro" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
