...
<div class="login-page" >
	<div id="zoom" class="cabeca" style="background-color:#F6FBFF;width: 40%;margin: 0 auto;background-size: cover;min-height: 100px;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);"><h1 style="font-family: monospace; font-size:56px;color:black;text-align: center;padding: center">Login</h1></div>
    	 ...
    	 <div class="login-head">
			...
			<div class="login-block">
				<form>
					...
					<a  href="index.php/Projeto/home"><input id="zoom"type="button" name="Logar" value="Logar"></a>	
