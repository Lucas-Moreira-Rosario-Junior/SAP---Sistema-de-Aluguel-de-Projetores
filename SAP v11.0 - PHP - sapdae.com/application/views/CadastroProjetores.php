...
<div class="inner-block">
     ...
     <div class="cabeca" style="background-color:#F6FBFF;width: 100%;margin: 0 auto;background-size: cover;min-height: 100px;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);"><h1 style="font-family: monospace; font-size:46px;color:black;text-align: center;padding: center">Cadastrar Projetores</h1></div>  	
    	 <div class="signup-head">
			</div>
			<div class="signup-block">

				<form action="salvarProjetores" name="form_add" method="post">
				    ...
				    <input name="Descricao"  style="height: 200px; width: 100%">
