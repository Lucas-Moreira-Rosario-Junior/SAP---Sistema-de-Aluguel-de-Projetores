	...
	<div style="margin-bottom: 25px;" class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div id="muda" class="chit-chat-heading">
                                  Cadastro de Servidores/Técnicos Adm.
                            </div>
                            	...
                            	<div id="divCenter">
                            		...
                            		<script type="text/javascript">
							      		function validar(){
							      			<?php
							      				foreach ($valido as $servidor) {
							      					echo '
							      						if(document.dados.MatriculaServidor.value=="'.$servidor->MatriculaServidor.'"){
							      							alert("Já existe o servidor -->'.$servidor->MatriculaServidor.'<-- no sistema!");
							      							return false;
							      						}';
							      				}
							      			?>
                                	...
                                	<form action="salvarServidores" name="dados" id="formulario" class="form-signin" style="background-color:white" method="post" onSubmit="return validar();">

							        <label id="muda" class="label" style="color:#2A2E2A">Matrícula do Servidor:</label>
							        <input id="zoom" name="MatriculaServidor" type="text" class="form-control" placeholder="Matrícula Servidor(a)" required autofocus>

							        <label id="muda" class="label" style="color:#2A2E2A">Nome Completo:</label>
							        <input id="zoom" name="nomeServidor" type="text" class="form-control" placeholder="Nome" required >
							        <label id="muda" class="label" style="color:#2A2E2A">Setor:</label>
							        <input id="zoom" name="setorServidor" type="text" class="form-control" placeholder="Setor" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Email:</label>
							        <input id="zoom" name="emailServidor" type="text" class="form-control" placeholder="Email" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Telefone:</label>
							        <input id="zoom" name="telefoneServidor" type="text" class="form-control" placeholder="Telefone" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Senha:</label>
							        <input id="zoom" name="senhaServidor" type="text" class="form-control" placeholder="Senha" required>
