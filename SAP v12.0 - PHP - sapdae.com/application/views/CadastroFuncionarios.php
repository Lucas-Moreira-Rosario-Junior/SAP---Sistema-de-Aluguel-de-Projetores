	...
	<div style="margin-bottom: 25px;" class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div id="muda" class="chit-chat-heading">
                                  Cadastro de Funcionários do DAE.
                            </div>
                            	<div id="divCenter">
                                 <form action="salvarFuncionarios" id="formulario" class="form-signin" style="background-color:white" method="post">
        
							        <label id="muda" class="label" style="color:#2A2E2A">Matrícula do Funcionario:</label>
							        <input id="zoom" name="MatriculaFuncionario" type="text" class="form-control" placeholder="Matrícula de Funcionário(a)" required autofocus>
							        <label id="muda" class="label" style="color:#2A2E2A">Nome Completo:</label>
							        <input id="zoom" name="nomeFuncionario" type="text" class="form-control" placeholder="Nome" required >
							        <label id="muda" class="label" style="color:#2A2E2A">Email:</label>
							        <input id="zoom" name="emailFuncionario" type="text" class="form-control" placeholder="Email" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Telefone:</label>
							        <input id="zoom" name="telefoneFuncionario" type="text" class="form-control" placeholder="Telefone" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Senha:</label>
							        <input id="zoom" name="senhaFuncionario" type="text" class="form-control" placeholder="Senha" required>
