	...
	<div style="margin-bottom: 25px;" class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div id="muda" class="chit-chat-heading">
                                  Atualizar dados dos Funcionários do DAE.
                            </div>
                            
                            	<div id="divCenter">
                            		
                                 <form action="../editarFunc" id="formulario" class="form-signin" style="background-color:white" method="post">
        
							        <label id="muda" class="label" style="color:#2A2E2A">Matrícula do Funcionário:</label>
							        <input id="zoom" name="MatriculaFuncionario" value="<?php echo $funcionario->MatriculaFuncionario ?>" type="text" class="form-control" placeholder="Matrícula Funcionário(a)" required autofocus>
							        <label id="muda" class="label" style="color:#2A2E2A">Nome Completo:</label>
							        <input id="zoom" name="nomeFuncionario" value="<?php echo $funcionario->nomeFuncionario ?>" type="text" class="form-control" placeholder="Nome" required >
							        <label id="muda" class="label" style="color:#2A2E2A">Email:</label>
							        <input id="zoom" name="emailFuncionario" value="<?php echo $funcionario->emailFuncionario ?>" type="text" class="form-control" placeholder="Email" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Telefone:</label>
							        <input id="zoom" name="telefoneFuncionario" value="<?php echo $funcionario->telefoneFuncionario ?>" type="text" class="form-control" placeholder="Telefone" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Senha:</label>
							        <input id="zoom" name="senhaFuncionario" value="<?php echo $funcionario->senhaFuncionario ?>" type="text" class="form-control" placeholder="Senha" required>
							         
							       
							        <input type="hidden" name="MatriculaFuncionarioAnt" value="<?php echo $funcionario->MatriculaFuncionario ?>">
							        <button  id="muda" class="btn btn-success " type="submit" >Editar</button>
							        <a  href="../../projeto/funcionarios"><button  id="muda" class="btn btn-success " type="button" >Voltar</button></a>
