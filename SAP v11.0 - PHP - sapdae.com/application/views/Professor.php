        ...
        <table class="table table-bordered">
            ...
            <?php
				...
				echo '<td class="text-center">';
                        echo '<a href="/index.php/Projeto/editarProfessor/'.$professor->MatriculaProfessor.'" title="Editar cadastro" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>';
                        echo ' <a href="/index.php/Projeto/deletarProfessor/'.$professor->MatriculaProfessor.'" title="Apagar cadastro" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
