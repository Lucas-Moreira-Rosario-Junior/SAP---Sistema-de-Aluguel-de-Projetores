	...
	<div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div id="muda" class="chit-chat-heading">
                            	...
                            	<div id="divCenter">
                                 <form action="salvarAluguel" id="formulario" class="form-signin" style="background-color:white" method="post">
        
							        <label id="muda" for="inputMatriculaP" class="label" style="color:#2A2E2A">Matrícula do Servidor(a):</label>
							        <select name="inputMatriculaS" id="zoom"  class="form-control" placeholder="Matrícula Servidor(a)" required autofocus>
							        	<?php
							        ...
							        <label for="inputData" class="label" style="color:#2A2E2A">Data de Aluguel:</label>
							        ...
							        <select name="inputRecurso" id="zoom" type="text"  class="form-control" placeholder="Número do Projetor (Exemplo: 1 ou 2 ou 3)" required>
							        ...
							        <button  id="muda" class="btn btn-success " type="submit" >Confirmar Aluguel</button>
							        <a  href="http://www.sapdae.com/index.php/projeto/devolver"><button  id="muda" class="btn btn-success " type="button" >Devolver</button></a>
