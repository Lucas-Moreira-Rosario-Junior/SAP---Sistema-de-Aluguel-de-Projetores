        ...
        <table class="table table-bordered">
            ...
            <?php
				...
				echo '<td class="text-center">';
                        ...
                        echo ' <a href="/index.php/Projeto/deletarServidor/'.$servidor->MatriculaServidor.'" title="Apagar cadastro" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
