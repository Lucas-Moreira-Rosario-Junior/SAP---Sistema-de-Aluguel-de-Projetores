                            ...
                            <div id="muda" class="chit-chat-heading">
                            	...
                            	<div id="divCenter">
                                 ...
                                 <form action="../editarServ" id="formulario" class="form-signin" style="background-color:white" method="post">
							        ...
							        <input id="zoom" name="MatriculaServidor" value="<?php echo $servidor->MatriculaServidor ?>" type="text" class="form-control" placeholder="Matrícula Servidor(a)" required autofocus>
							        ...
							        <button  id="muda" class="btn btn-success " type="submit" >Editar</button>
