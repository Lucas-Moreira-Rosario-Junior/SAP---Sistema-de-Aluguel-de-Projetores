	...
	<div style="margin-bottom: 25px;" class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div id="muda" class="chit-chat-heading">
                                  Atualizar dados de Prof(a)s.
                            </div>
                           		
                            
                            	<div id="divCenter">
                            		
                                 <form action="../editarProf" id="formulario" class="form-signin" style="background-color:white" method="post">
        
							        <label id="muda" class="label" style="color:#2A2E2A">Matrícula do Professor:</label>
							        <input id="zoom" name="MatriculaProfessor" value="<?php echo $professor->MatriculaProfessor ?>" type="text" class="form-control" placeholder="Matrícula Prof(a)" required autofocus>
							        <label id="muda" class="label" style="color:#2A2E2A">Nome Completo:</label>
							        <input id="zoom" name="nomeProfessor" value="<?php echo $professor->nomeProfessor ?>" type="text" class="form-control" placeholder="Nome" required >
							        <label id="muda" class="label" style="color:#2A2E2A">Departamento:</label>
							        <input id="zoom" name="departamento" value="<?php echo $professor->departamento ?>" type="text" class="form-control" placeholder="Setor" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Email:</label>
							        <input id="zoom" name="emailProfessor" value="<?php echo $professor->emailProfessor ?>" type="text" class="form-control" placeholder="Email" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Telefone:</label>
							        <input id="zoom" name="telefoneProfessor" value="<?php echo $professor->telefoneProfessor ?>" type="text" class="form-control" placeholder="Telefone" required>
							        <label id="muda" class="label" style="color:#2A2E2A">Senha:</label>
							        <input id="zoom" name="senhaProfessor" value="<?php echo $professor->senhaProfessor ?>" type="text" class="form-control" placeholder="Senha" required>
							         
							       
							        <input type="hidden" name="MatriculaProfessorAnt" value="<?php echo $professor->MatriculaProfessor ?>">
