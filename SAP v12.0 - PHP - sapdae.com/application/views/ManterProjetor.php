        ...
        <table class="table table-bordered">
            ...
            <?php
				...
				echo '<td class="text-center">';
                        ...
                        echo ' <a href="/index.php/Projeto/deletarProjetor/'.$projetor->idProjetor.'"

                         onclick="return confirm(\'Você tem certeza que deseja deletar? Todo o histórico do projetor será apagado!\')" 
